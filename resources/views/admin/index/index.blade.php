...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
				...
				<ul class="cl">
					<li class="dropDown dropDown_hover"><a href="javascript:;" class="dropDown_A"><i class="Hui-iconfont">&#xe600;</i> 新增 <i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							<li><a href="javascript:;" onclick="article_add('添加专业','article-add.html')"><i class="Hui-iconfont">&#xe616;</i> 专业</a></li>
							<li><a href="javascript:;" onclick="picture_add('添加专业','picture-add.html')"><i class="Hui-iconfont">&#xe613;</i> 图片</a></li>
							<li><a href="javascript:;" onclick="product_add('添加专业','product-add.html')"><i class="Hui-iconfont">&#xe620;</i> 产品</a></li>
		...
		<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
			<ul class="cl">
				<li>{{Auth::guard('admin') -> user() -> roles -> role_name}}</li>
		...
		<dl id="menu-picture">
			...
			<dd>
				<ul>
					...
					<li><a data-href="/admin/lessions/index" data-title="点播列表" href="javascript:void(0)">点播列表</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-product">
			...
			<dd>
				<ul>
					...
					<li><a data-href="/admin/question/index" data-title="试题列表" href="javascript:void(0)">试题列表</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-comments">
			...
			<dd>
				<ul>
					...
					<li><a data-href="/admin/live/index" data-title="直播列表" href="javascript:void(0)">直播列表</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-member">
			...
			<dd>
				<ul>
					<li><a data-href="/admin/members/index" data-title="会员列表" href="javascript:;">会员列表</a></li>
			...
			<dd>
				<ul>
					...
					<li><a data-href="/admin/auth/index" data-title="权限管理" href="javascript:void(0)">权限管理</a></li>
						<li><a data-href="/admin/admin/index" data-title="管理员列表（客户端）" href="javascript:void(0)">管理员列表（客户端）</a></li>
						<li><a data-href="/admin/admin/serverSide" data-title="管理员列表（服务端）" href="javascript:void(0)">管理员列表（服务端）</a></li>
			</ul>
		</dd>
	</dl>
		<dl id="menu-tongji">
