	...
	<table class="table table-border table-bordered table-hover table-bg">
		<thead>
			...
			<tr class="text-c">
				...
				<th width="40">ID</th>
				<th width="200">角色名</th>
				<th width="120">权限id集合</th>
				<th width="300">权限AC</th>
				<th width="70">操作</th>
			</tr>
		</thead>
		<tbody>
			...
			<tr class="text-c">
				...
				<td class="f-14">
					...
					<a title="编辑" href="javascript:;" onclick="admin_role_edit('角色编辑','admin-role-add.html','{{$val -> id}}')" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> 
