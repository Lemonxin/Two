...
<body>
        ...
        <form class="form form-horizontal" id="form-admin-add">
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" value="" placeholder="请输入权限名称" id="auth_name" name="auth_name">
                </div>
            </div>
            <div class="row cl">
            ...
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-3">作为父级：</label>
    ...
    $(function(){
        // 优化表单的体验，如果选择的权限为顶级权限，则需要清空控制器和方法的input框的值，或者隐藏
