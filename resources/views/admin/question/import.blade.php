...
<body>
    <article class="page-container">
        <form action="" method="post" class="form form-horizontal" enctype="multipart/form-data" id="form-paper-add">
            <div class="row cl">
            ...
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-3">请选择文件：</label>
                <div class="formControls col-xs-8 col-sm-9"> 
