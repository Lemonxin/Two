<!DOCTYPE html>
<!-- saved from url=(0023)http://www.boxuegu.com/ -->
<html lang="en">
    ...
    <header>
        <div class="header_body">
            <div class="header_left"><a href="http://www.boxuegu.com/index.html"><img src="/home/img/logo.png" alt=""></a>
                <div class="path"><a href="http://www.boxuegu.com/index.html" class="select">云课堂</a><a href="http://www.boxuegu.com/web/html/ansAndQus.html">问答精灵</a></div>
            </div>
                ...
                <div class="loginGroup">
                    <div class="login" style="display: block;">
                        <div class="dropdown" id="myDropdown">
                            ...
                            <div id="dLabel" data-target="#" role="button" aria-haspopup="true"><span class="name" title="admin">admin</span><span class="caret"></span> </div>
                            ...
                            <a href="http://www.boxuegu.com/web/html/payCourseDetailPage.html?id=109&amp;courseType=1&amp;free=0" target="_blank">
                                ...
                                <div class="recommend-course-items-details clearfix">
                                    ...
                                    <div class="courseDetails clearfix"><span class="coursePrice"><i>￥</i>1500.00</span>
                                        <del><i class="price1">￥</i>2998.00</del><span class="studentCount"><img src="/homethink/img/studentCount.png" alt=""><span class="studentCou">0</span></span>
                                    </div>
                                </div>
                            </a>
                        </li>
            ...
            <div id="public-class-live">
                ...
                <div style="width:110%;">
                    <ul class="public-class-live-content clearfix">
                        @foreach($live as $val)
                        <li>
                            <a style="cursor:pointer" data-url="/home/live?id={{val -> id}}" target="_blank">
                                ...
                                <div class="public-class-live-detail">
                                    ...
                                    <div class="detailLiveInfo clearfix">
                                        <div class="detailLiveDate">最近直播：{{date('m/d H:i',$val -> begin_at}}</div>
                                        <div class="detailLiving"><img src="{{/home/img/zhiboNoStart.png}}" alt=""><span class="noStart">{{$val -> liveStatus}}</span></div>
                                    </div>
                                </div>
                            </a>
                        </li>
                    ...
                    <div id="content" class="content clearfix" style="width: 110%;">
                        ...
                        @foreach($profession as $val)
                         <div class="course clearfix">
                            <a href="http://www.boxuegu.com/web/html/payCourseDetailPage.html?id=122&amp;courseType=1&amp;free=0" target="_blank">
                                <div class="img"><img src="/home/img/968e45accbc34073b93d75dfa49a42f7.png"></div><span class="classCategory">点播</span>
                                <div class="detail">
